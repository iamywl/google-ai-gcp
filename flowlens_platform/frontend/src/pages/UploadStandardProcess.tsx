...
export default function UploadStandardProcess() {
  return (
    <div>
      <h1 style={marginBottom: '1.5rem'}>표준 프로세스 업로드</h1>
      <p style={marginBottom: '2rem', color: '#64748b'}>이 화면은 117개의 기능 명세 중 '표준 프로세스 업로드' 모듈을 구현한 뷰입니다.</p>
