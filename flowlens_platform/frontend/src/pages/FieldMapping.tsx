...
export default function FieldMapping() {
  return (
    <div>
      <h1 style={marginBottom: '1.5rem'}>필드 매핑 UI (Field Mapping)</h1>
      <p style={marginBottom: '2rem', color: '#64748b'}>이 화면은 117개의 기능 명세 중 '필드 매핑 UI (Field Mapping)' 모듈을 구현한 뷰입니다.</p>
