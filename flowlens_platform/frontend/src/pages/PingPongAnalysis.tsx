...
export default function PingPongAnalysis() {
  return (
    <div>
      <h1 style={marginBottom: '1.5rem'}>부서 간 핑퐁 탐지 (Ping-pong)</h1>
      <p style={marginBottom: '2rem', color: '#64748b'}>이 화면은 117개의 기능 명세 중 '부서 간 핑퐁 탐지 (Ping-pong)' 모듈을 구현한 뷰입니다.</p>
