...
export default function IdleCases() {
  return (
    <div>
      <h1 style={marginBottom: '1.5rem'}>장기 방치 및 유휴 탐지</h1>
      <p style={marginBottom: '2rem', color: '#64748b'}>이 화면은 117개의 기능 명세 중 '장기 방치 및 유휴 탐지' 모듈을 구현한 뷰입니다.</p>
