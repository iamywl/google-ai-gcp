...
export default function DataScheduler() {
  return (
    <div>
      <h1 style={marginBottom: '1.5rem'}>수집 스케줄러 (Scheduler)</h1>
      <p style={marginBottom: '2rem', color: '#64748b'}>이 화면은 117개의 기능 명세 중 '수집 스케줄러 (Scheduler)' 모듈을 구현한 뷰입니다.</p>
